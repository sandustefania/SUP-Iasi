    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                user = _c.sent();
                //admin
                if ((user === null || user === void 0 ? void 0 : user.email) === "sandu.stefaniaalina@yahoo.com") {
            ...
            case 3:
                ...
                if (_b) {
                    ...
                    res.status(http_status_1.HTTP_BAD_REQUEST).send("Email sau parola invalide!");
                }
                return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                if (user) {
                    // res.status(400)
                    res.status(http_status_1.HTTP_BAD_REQUEST).send("Acest e-mail deja exista, va rugam autentificati-va!");
                    return [2 /*return*/];
                }
